...
p35_recovered_forest(t,j,ac)$(sum(ac2, p35_other(t,j,ac2) - p35_recovered_forest(t,j,ac2)) < pm_land_conservation(t,j,"other","protect")) = p35_recovered_forest(t,j,ac) * (1 - (pm_land_conservation(t,j,"other","protect") - sum(ac2, p35_other(t,j,ac2)) + sum(ac2,p35_recovered_forest(t,j,ac2)))/sum(ac2,p35_recovered_forest(t,j,ac2)+10e-5));
